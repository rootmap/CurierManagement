...
<!--[if !IE]><!--><html><!-- <![endif]-->
    <head><?php  
    echo $plugin->softwareTitle("Unit");
    ...
    <body class="">
        ...
        <div id="content">
        	<h1 class="content-heading bg-white border-bottom">Unit</h1>
            <div class="innerAll bg-white border-bottom">
                <ul class="menubar">
                    <li class="active"><a href="#">Create New Unit</a></li>
                    <li><a href="unit_data.php">Unit List</a></li>
                </ul>
            </div>
                ...
                <!-- Widget -->
                        ...
                        <div class="widget widget-inverse" >
                            ...
                            <div class="widget-head">
                                <h4 class="heading">Update/Change - Unit</h4>
                            </div>
                            <!-- // Widget heading END -->
                            ...
                            <!-- Widget heading -->
                            <div class="widget-head">
                                <h4 class="heading">Create New Unit</h4>
                            </div>
                            <!-- // Widget heading END -->
