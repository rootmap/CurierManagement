...
cod.id,
dos.name as division_id,
d.name as district_id,
cod.price,
cod.date
FROM cash_on_delivery as cod
LEFT JOIN division_or_state as dos ON dos.id = cod.division_id
LEFT JOIN district as d ON d.id = cod.district_id ");
