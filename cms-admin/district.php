<?php 
		...
		if(isset($_POST['create'])){
			extract($_POST);
			if(!empty($division_id) && !empty($name))
			{  $insert=array('division_id'=>$division_id,'name'=>$name,'date'=>date('Y-m-d'),'status'=>1);
		...
		{
			extract($_POST);if(!empty($division_id) && !empty($name))
			{$updatearray=array("id"=>$id);$upd2=array('division_id'=>$division_id,'name'=>$name,'date'=>date('Y-m-d'),'status'=>1);
...
<!--[if !IE]><!--><html><!-- <![endif]-->
    <head><?php  
    echo $plugin->softwareTitle("District");
    ...
    <body class="">
        ...
        <div id="content">
        	<h1 class="content-heading bg-white border-bottom">District</h1>
            <div class="innerAll bg-white border-bottom">
                <ul class="menubar">
                    <li class="active"><a href="#">Create New District</a></li>
                    <li><a href="district_data.php">District List</a></li>
                </ul>
            </div>
                ...
                <!-- Widget -->
                        ...
                        <div class="widget widget-inverse" >
                            ...
                            <div class="widget-head">
                                <h4 class="heading">Update/Change - District</h4>
                            </div>
                            <!-- // Widget heading END -->
                        ...
                        if(!empty($sqldivision_id))
                        {
                            ...
                            <!-- Widget heading -->
                            <div class="widget-head">
                                <h4 class="heading">Create New District</h4>
                            </div>
                            <!-- // Widget heading END -->
