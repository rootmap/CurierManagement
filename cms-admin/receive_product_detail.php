<?php 
		...
		if(isset($_POST['create'])){
			...
			{  $insert=array('tracking_no'=>$tracking_no,'division_id'=>$division_id,'district_id'=>$district_id,'date'=>date('Y-m-d'),'status'=>1);
				if($obj->insert("receive_product_detail",$insert)==1)
				{
...
<!--[if !IE]><!--><html><!-- <![endif]-->
    <head><?php  
    echo $plugin->softwareTitle("Receive Product Detail");
    ...
    <body class="">
        ...
        <div id="content">
        	<h1 class="content-heading bg-white border-bottom">Receive Product Detail</h1>
            <div class="innerAll bg-white border-bottom">
                <ul class="menubar">
                    <li class="active"><a href="#">Create New Receive Product Detail</a></li>
                    <li><a href="receive_product_detail_data.php">Receive Product Detail List</a></li>
                </ul>
            </div>
                ...
                <!-- Widget -->
                        ...
                        <div class="widget widget-inverse" >
                            ...
                            <div class="widget-head">
                                <h4 class="heading">Update/Change - Receive Product Detail</h4>
                            </div>
                            <!-- // Widget heading END -->
                        ...
                        if(!empty($sqldistrict_id))
                        {
                            ...
                            <!-- Widget heading -->
                            <div class="widget-head">
                                <h4 class="heading">Create New Receive Product Detail</h4>
                            </div>
                            <!-- // Widget heading END -->
