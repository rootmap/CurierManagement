...
<!--[if !IE]><!--><html><!-- <![endif]-->
    <head><?php  
    echo $plugin->softwareTitle("User Type");
    ...
    <body class="">
        ...
        <div id="content">
        	<h1 class="content-heading bg-white border-bottom">User Type</h1>
            <div class="innerAll bg-white border-bottom">
                <ul class="menubar">
                    <li class="active"><a href="#">Create New User Type</a></li>
                    <li><a href="user_type_data.php">User Type List</a></li>
                </ul>
            </div>
                ...
                <!-- Widget -->
                        ...
                        <div class="widget widget-inverse" >
                            ...
                            <div class="widget-head">
                                <h4 class="heading">Update/Change - User Type</h4>
                            </div>
                            <!-- // Widget heading END -->
                            ...
                            <!-- Widget heading -->
                            <div class="widget-head">
                                <h4 class="heading">Create New User Type</h4>
                            </div>
                            <!-- // Widget heading END -->
